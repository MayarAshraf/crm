...
@Component({
  selector: "app-lead-over-interests",
  standalone: true,
  imports: [DividerModule, TooltipModule, ButtonModule, TableWrapperComponent],
  templateUrl: "./lead-over-interests.component.html",
  styleUrl: "./lead-over-interests.component.scss",
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export default class LeadOverInterestsComponent extends BaseIndexComponent<any> {
  ngOnInit() {
    this.indexMeta = {
      ...this.indexMeta,
      endpoints: { index: "" },
