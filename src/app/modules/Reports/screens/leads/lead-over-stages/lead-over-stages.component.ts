...
@Component({
  selector: "app-lead-over-stages",
  standalone: true,
  imports: [DividerModule, TooltipModule, ButtonModule, TableWrapperComponent],
  templateUrl: "./lead-over-stages.component.html",
  styleUrl: "./lead-over-stages.component.scss",
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export default class LeadOverStagesComponent extends BaseIndexComponent<any> {
  ngOnInit() {
    this.indexMeta = {
      ...this.indexMeta,
      endpoints: { index: "" },
      ...
      columns: [
        { name: "created_at", title: "send At", searchable: false, orderable: true },
        {
