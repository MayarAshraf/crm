...
@Component({
  selector: "app-lead-over-tag",
  standalone: true,
  imports: [DividerModule, TooltipModule, ButtonModule, TableWrapperComponent],
  templateUrl: "./lead-over-tag.component.html",
  styleUrl: "./lead-over-tag.component.scss",
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export default class LeadOverTagComponent extends BaseIndexComponent<any> {
  ngOnInit() {
    this.indexMeta = {
      ...this.indexMeta,
      endpoints: { index: "" },
