...
@Component({
  selector: "app-search-leads-documentation",
  standalone: true,
  imports: [PreCodeComponent, DividerModule, DefaultScreenHeaderComponent, TranslateModule],
  templateUrl: "./search-leads-documentation.component.html",
  styleUrl: "./search-leads-documentation.component.scss",
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export default class SearchLeadsDocumentationComponent {
  OAuth = `
      -client_id=2
