...
@Component({
  selector: "app-web-form-lead-generation-documentation",
  standalone: true,
  imports: [PreCodeComponent, DividerModule, DefaultScreenHeaderComponent, TranslateModule],
  templateUrl: "./web-form-lead-generation-documentation.component.html",
  styleUrl: "./web-form-lead-generation-documentation.component.scss",
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export default class WebFormLeadGenerationDocumentationComponent {
  OAuth = `
      -client_id=2
