...
export class GroupPermissionsDialogComponent extends BaseCreateUpdateComponent<any> {
  ...
  groupPermissions$ = this.#groupService
    .updateGropuPermissions(this.editData.id)
    .pipe(shareReplay(1));

  ngOnInit() {
    this.dialogMeta = {
      ...this.dialogMeta,
      dialogData$: this.groupPermissions$,
      dialogTitle: this.translate.instant(_("update_group_permissions")),
      submitButtonLabel: this.translate.instant(_("update_group_permissions")),
      showResetButton: false,
      endpoints: {
        update: "groups/updateGroupPermissions",
      },
    };
